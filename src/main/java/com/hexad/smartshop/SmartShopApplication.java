...
//		Customer customer=customerInit.getCustomerById(CustTestData.CUSTOMER_GET_ID);
		...
		logger.info("OrderId: "+orderMade.getOrderId()+" | OrderDate: "+orderMade.getDateOfOrder()+" | Current Status: "+orderMade.getCurrentStatus()+
				" | Expected Delivery Date: "+orderMade.getDeliveryDate()+" | Order Price: "+orderMade.getTotalPrice());
